...
<template>
  <div id="treaty">
    ...
    <!-- title end -->
    <!-- 协议内容 start -->
    <el-row class="treaty-wrapper">
      <el-col :span="24">
        <div>
          <h4>一、总则</h4>
          <ol>
            <li>莘灼平台的所有权和运营权归本站开发者个人所有。</li>
            <li>
              用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与莘灼平台之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。
            </li>
            <li>
              本协议则可由莘灼平台随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分。
            </li>
          </ol>
          <h4>二、服务内容</h4>
          <ol>
            <li>莘灼平台的具体内容由本站根据实际情况提供。</li>
            <li>
          ...
          <ol>
            <li>
              经本站注册系统完成注册程序并通过身份认证的用户即成为正式用户，可以获得本站规定用户所应享有的一切权限；未经认证仅享有本站规定的部分会员权限。莘灼平台有权对会员的权限设计进行变更。
            </li>
            <li>
              用户只能按照注册要求使用真实姓名，及手机号注册。用户有义务保证密码和帐号的安全，用户利用该密码和帐号所进行的一切活动引起的任何损失或损害，由用户自行承担全部责任，本站不承担任何责任。如用户发现帐号遭到未授权的使用或发生其他任何安全问题，应立即修改帐号密码并妥善保管，如有必要，请通知本站。因黑客行为或用户的保管疏忽导致帐号非法使用，本站不承担任何责任。
            </li>
          </ol>
          <h4>四、使用规则</h4>
          <ol>
          ...
          <ol>
            <li>
              本站的文字、图片、音频、视频等版权均归本站开发者个人享有，未经本站许可，不得任意转载。
            </li>
            <li>
              本站特有的标识、版面设计、编排方式等版权均属本站开发者个人享有，未经本站许可，不得任意复制或转载。
            </li>
            <li>
              使用本站的任何内容均应注明“来源于莘灼平台”及署上作者姓名，按法律规定需要支付稿酬的，应当通知本站及作者及支付稿酬，并独立承担一切法律责任。
            </li>
            <li>
          ...
          <ol>
            <li>
              用户明确同意其使用本站网络服务所存在的风险及一切后果将完全由用户本人承担，莘灼平台对此不承担任何责任。
            </li>
            <li>
            ...
            <li>
              ...
              <ul>
                <li>本站向用户免费提供的各项网络服务；</li>
                <li>本站向用户赠送的任何产品或者服务。</li>
              </ul>
            </li>
            <li>
